...
contract DeFiNiFTy is BEP20('DeFiNiFTy', 'DEFINIFTY') {
    ...
    external
    {
        ...
        require(signatory != address(0), "DeFiNiFTy::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DeFiNiFTy::delegateBySig: invalid nonce");
        require(now <= expiry, "DeFiNiFTy::delegateBySig: signature expired");
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "DeFiNiFTy::getPriorVotes: not yet determined");
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "DeFiNiFTy::_writeCheckpoint: block number exceeds 32 bits");
